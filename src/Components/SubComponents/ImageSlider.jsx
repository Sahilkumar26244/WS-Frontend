...
function ImageSlider({portfolio}) {
  ...
  return (
    <>
    <Box m={"auto"} position={'relative'} height={{base:"460px",lg:'500px'}} width={{base:"80%",lg:'500px'}} overflow={'hidden'}>
    ...
    <Slider {...settings} ref={(slider) => setSlider(slider)}>
      {portfolio?.map((card, index) => (
        <Box
          ...
          <Container  pl={"20px"} pr={"20px"} size="container.lg" height={{base:"700px",lg:"600px"}}  display={"flex"} justifyContent={"center"} alignItems={"center"}>
            <Stack
            spacing={6}
